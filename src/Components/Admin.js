    ...
    return (
        <div>
            ...
            {lead ?
                <div id="id1">
                    <h1>lead List</h1>
                    <Link to="Lead"><button>Add Lead</button></Link><br /><br />
                                ...
                                leads_list.map(function (item, index) {
                                    return (
                                        <tr key={index} >
                                            ...
                                            <td style={{ border: "2px solid black" }}><button onClick={(Event)=>{window.location="Convert";convertid(Event)}}>Convert</button></td>
                                            <td style={{ border: "2px solid black" }}><button onClick={(Event) => { setmodalIsOpen(true); getLeadData(Event) }} >Edit</button></td>
                                            <td style={{ border: "2px solid black" }}><button onClick={(Event) => {setdeletemodalIsOpen(true); setleaddeleteid(Event)}}>Delete</button></td>
                                        </tr>
                                    );
                                })}
            ...
            {contact ?
                <div id="id2">
                    <h1>Contact List</h1>
                    <Link to="Contact"><button>Add Contact</button></Link><br /><br />
                                ...
                                contact_list.map(function (item, index) {
                                    return (
                                        <tr key={index}>
                                            ...
                                            <td style={{ border: "2px solid black" }}>{item.lead_stage}</td>
                                            <td style={{ border: "2px solid black" }}>{item.phone}</td>                                            
                                            <td style={{ border: "2px solid black" }}><button onClick={(Event) => {setcontactdeletemodalIsOpen(true); setcontactdeleteid(Event)}}>Delete</button></td>
                                        </tr>
                                    );
                                })}
            ...
            <Modal isOpen={modalIsOpen} onRequestClose={() => setmodalIsOpen(false)}>
                ...
                <button onClick={() => { {setmodalIsOpen(false);global.id ="";} }}>close</button>
